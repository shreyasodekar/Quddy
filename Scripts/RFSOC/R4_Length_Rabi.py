...
# Q ---|Rx|------------
# R ----------|Measure|
# Rx pulse length is being sweep
...
expt_cfg = {'start': 0.008, ## us. Must be more than 0.008
            'stop': 4,    ## us. Must be less than ----
            'points': 100
            }
...
if show_plot:
    ...
    popt, pcov = curve_fit(fitter.sinedecay, x_pts, data.real, p0=[1,1,1,10,-1.5])
    fig = plt.figure(figsize=(16,6))
    plt.subplot(121,title="Length Rabi", xlabel="Pulse Length (us)", ylabel="Amp. (adc level)")
